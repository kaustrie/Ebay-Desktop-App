 ...
 * GetCategories.java
 *
 * Complete category tree is downloaded and stored and kept upto date.
 * Then the user is allowed to continually select categoires and subcategories
 * until they select a leaf node.
 *
...
public class GetCategories {
    ...
    public static void main(String[] args)
    {
        ...
        //if cat tree ws not loaded during checking, load now
        if(catTree == null)
        {
            try
            {
        ...
        outputMainCategories(categories);

        //ask user to keep selecting categories until they select a leaf node
        System.out.print("\nEnter Category ID: ");
     ...
     */
    private static void outputSubCategories(Node categoryArray, String parentCategoryID)
    {
        String catID = "";
        String parentID = "";
        String name = "";
     ...
     */
    private static void outputMainCategories(Node categoryArray)
    {
        String catID = "";
        String parentID = "";
        String name = "";
